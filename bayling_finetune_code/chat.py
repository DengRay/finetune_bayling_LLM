...
class RichChatIO(ChatIO):
    def __init__(self):
        ...
        self._console.print(
            "Welcome to interact with BayLing!", style=style, justify="center"
        )
        self._console.print(
            "- Enter your question and press 'Enter' to interact with BayLing.",
            style="white on blue",
            justify="left",
        )
        self._console.print(
    ...
    def prompt_for_output(self, role: str):
        self._console.print(f"[bold]BayLing:\n", end="")
